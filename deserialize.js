function popuniFormu() {
  ...
  if (objekat.ocena != null && objekat.ocena >= 5 && objekat.ocena <= 10) {
    ...
    document
      .getElementById("podaciforme")
      .insertAdjacentHTML(
        "afterend",
        `<p class="poruka-greske">* Ocena nije ispravno uneta</p>`
      );
  }
  if (objekat.brojIndeksa != null && proveriIndeks(objekat.brojIndeksa)) {
    ...
    document
      ...
      .insertAdjacentHTML(
        "afterend",
        `<p class="poruka-greske">* Broj indeksa nije ispravno unet</p>`
      );
  }
  if (objekat.redniBrojIzlaska != null && objekat.redniBrojIzlaska >= 1 && objekat.redniBrojIzlaska <=5) {
    ...
    document
      ...
      .insertAdjacentHTML(
        "afterend",
        `<p class="poruka-greske">* Redni broj nije ispravno unet</p>`
      );
  }
  if (objekat.datumIzlaska != null) {
    ...
    document
      ...
      .insertAdjacentHTML(
        "afterend",
        `<p class="poruka-greske">* Datum izlaska nije ispravno unet</p>`
      );
  }
  if (
    objekat.rok != null &&
    ...
    document
      ...
      .insertAdjacentHTML(
        "afterend",
        `<p class="poruka-greske">* Rok nije ispravno unet</p>`
      );
  }
  if (objekat.polozen != null) {
    ...
    document
      ...
      .insertAdjacentHTML(
        "afterend",
        `<p class="poruka-greske">* Polje polozio/la nije ispravno uneto</p>`
      );
  }
}
...
ucitaj.addEventListener("click", ucitajFunkcija);
